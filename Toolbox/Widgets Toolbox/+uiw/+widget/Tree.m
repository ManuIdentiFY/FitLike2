classdef Tree < uiw.abstract.JavaControl
    ...
    methods (Access=protected)
        ...
        function create(obj)
            ...
            if isempty(obj.Root)
                obj.Root = uiw.widget.TreeNode('Name','Root','Tree',obj);
            end
    ...
    methods (Access=private)
        ...
        function onMouseEvent(obj,jEvent)
            ...
            if obj.isvalid() && obj.CallbacksEnabled
                ...
                addprop(mouseEvent,'Nodes');
                mouseEvent.Nodes = getNodeFromMouseEvent(obj,jEvent);
                ...
                switch mouseEvent.Interaction
                    case 'ButtonClicked'
                        ...
                        if ~any(obj.SelectedNodes == mouseEvent.Nodes)
                            % Call right to Java, so we trigger node
                            % selection callback in this unique case
                            if isscalar(mouseEvent.Nodes)
                                obj.JControl.setSelectionPath(mouseEvent.Nodes.JNode.getTreePath());
                            else
        ...
        function onKeyPressed(obj,e)
            ...
            if obj.isvalid() && obj.CallbacksEnabled && ~isempty(obj.KeyPressedCallback)
