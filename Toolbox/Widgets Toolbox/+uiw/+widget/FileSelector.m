    ...
    methods
        ...
        function set.Pattern(obj,value)
            if ~iscell( value ) ...
                ...
                error( 'uiw:widget:FileSelector:BadFilePattern', 'Property ''FilterSpec'' must be a valid file filter specification suitable for use with UIGETFILE. See <a href="matlab:doc uigetfile">UIGETFILE documentation</a> for details.' );
            end
            obj.Pattern = value;
        end
