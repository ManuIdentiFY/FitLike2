classdef Table < uiw.abstract.JavaControl
    ...
    properties (Constant, GetAccess=protected)
        DEFAULTCOLUMNWIDTH = 75 %Default width of columns
    ...
    methods (Access=protected)
            ...
            if obj.isvalid()
                ...
                switch mouseEvent.Interaction
                    ...
                    case 'ButtonDown'
                        ...
                        obj.notify('ButtonDown',mouseEvent);
                        hgfeval(obj.ButtonDownFcn,obj,mouseEvent);
                    ...
                    case 'ButtonMotion'
                        ...
                        hgfeval(obj.MouseMotionFcn,obj,mouseEvent);
        ...
        function onSelectionChanged(obj, ~, e)
            ...
            if obj.isvalid() && ~e.getValueIsAdjusting()
        ...
        function onTableModelChanged(obj, ~, e)
            ...
            if isscalar(rIdx) && rIdx>0
                ...
                % Call the callback
                if ~isequal(evt.OldValue, evt.NewValue)
    ...
    methods
        ...
        function setCell(obj,rIdx,cIdx,value)
            ...
            if isnumeric(obj.DataM) && ~isnumeric(value)
        ...
        function stopEditing(obj)
            ...
            jEditor = javaMethodMT('getCellEditor',obj.JControl);
            if ~isempty(jEditor)
                javaMethodMT('stopCellEditing',jEditor);
            end
    ...
    methods (Access=private)
        ...
        function updateNumberOfColumns(obj,NumCol,FlagRemove)
            ...
            if NumCol>jNumCol
                ...
                for idx=(jNumCol+1):NumCol
                    jCol = obj.constructJObj('javax.swing.table.TableColumn',...
                        idx-1, obj.DEFAULTCOLUMNWIDTH);
                    jColumnModel.addColumn(jCol);
                    obj.ColumnFormatEnum(idx) = uiw.enum.TableColumnFormat.DEFAULT;
                end
                obj.redrawJava_private();
            elseif NumCol<jNumCol && FlagRemove
                % Remove columns
                for idx=jNumCol:-1:(NumCol+1)
                    jCol = jColumnModel.getColumn(idx-1);
                    jColumnModel.removeColumn(jCol);
                end
                obj.JTableModel.setColumnCount(NumCol);
                obj.redrawJava_private();
            end %NumCol>jNumCol
    ...
    methods
        ...
        function set.Data(obj, value)
            ...
            validateattributes(value,{'cell'},{'2d'})
