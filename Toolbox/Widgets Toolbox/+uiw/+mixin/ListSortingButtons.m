classdef ListSortingButtons < uiw.mixin.HasContainer & uiw.mixin.HasCallback
    % ListSortingButtons - Mixin to provide list editing and ordering buttons
    %
    ...
    methods
        ...
        % Constructor
        function obj = ListSortingButtons()
            % Create the buttons
        ...
        function bInfoOut = getButtonInfo()
            ...
            if isempty(bInfo)
                ...
                bInfo = {
                    ...
                    'Delete',   uiw.utility.loadIcon( @()imread('delete_24.png') ),      'Delete the highlighted item from the list.'
                    'MoveUp',   uiw.utility.loadIcon( @()imread('arrow_up_24.png') ),    'Move the highlighted item up.'
                    'MoveDown', uiw.utility.loadIcon( @()imread('arrow_down_24.png') ),  'Move the highlighted item down.'
                    'Reverse',  uiw.utility.loadIcon( @()imread('arrows_up_down_24.png') ),'Reverses the order of all items.'
                    'Copy',     uiw.utility.loadIcon( @()imread('copy_24.png') ),        'Add copies of the highlighted item to the list.'
                    'Edit',     uiw.utility.loadIcon( @()imread('edit_24.png') ),        'Edit the highlighted item.'
