classdef (Abstract) HasLabel < handle
    % HasLabel - Mixin class for a Widget Label
    %
    ...
    properties (AbortSet, Dependent)
        ...
        LabelFontWeight double %Font weight of the label [(normal)|bold]
