    ...
    methods
        ...
        function [this, tf] = addPlot(this, hData, varargin) 
            ...
            if isempty(this.hData)
                ...
                if ~all(strcmp(getZoneID(this),...
                        strcat(hData.fileID,'@',num2str(varargin{1}))) == 0)
                   tf = 1; 
                   return
                else 
                   tf = 0;
            ...
            this.idxZone = [this.idxZone varargin{1}];
        ...
        function this = deletePlot(this, hData, varargin)
            ...
            if isempty(varargin{1})
                ...
                zoneID = [hData.fileID,'@',num2str(varargin{1})];
                % loop over axis
                for k = 1:numel(hAxe)
        ...
        % get zone ID
        function zoneID = getZoneID(this)
            % concatenate the original ID with the zone index
            zoneID = strcat({this.hData.fileID},'@',...
