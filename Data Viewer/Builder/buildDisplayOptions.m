...
opts_button = uix.HBox( 'Parent', box,'Spacing',10);

% + display options panel
panel_display_opts = uix.Panel( 'Parent', opts_button,...
...
opts_button_box1 = uix.VButtonBox( 'Parent', box_display_opts,...
                                   ...
                                   'ButtonSize', [100 20] );                                
uicontrol( 'Parent', opts_button_box1,...
                  'Style', 'checkbox',...
                  'Value',1,...
                  'String', 'Show data',...
                  'Tag','DataCheckButton');  
...
opts_button_box2 = uix.VButtonBox( 'Parent', box_display_opts,...
                                   ...
                                   'HorizontalAlignment','left',...
                                   'ButtonSize', [100 20] );  
uicontrol( 'Parent', opts_button_box2,...
                  'Style', 'checkbox',...
                  'Value',0,...
                  'String', 'Show error',...
...
opts_button_box3 = uix.VButtonBox( 'Parent', box_display_opts,...
                                   ...
                                   'HorizontalAlignment','left',...
                                   'ButtonSize', [100 20] );  
uicontrol( 'Parent', opts_button_box3,...
                  'Style', 'checkbox',...
                  'Value',1,...
                  'Tag','FitCheckButton',...
                  'String', 'Show fit');                                
...
% + data options panel
panel_data_opts = uix.Panel( 'Parent', opts_button,...
                   'Title', 'Data options',...
                   'Padding',2);
...
uix.Text( 'Parent', opts_button_XAxis,...
            'String','XAxis: ');
uicontrol( 'Parent', opts_button_XAxis,...
            'Style','popup',...
            'String', {'Linear','Log'},...
            'Value',2,...
            'Tag','XAxisPopup');
...
uix.Text( 'Parent', opts_button_YAxis,...
            'String','YAxis: ');        
uicontrol( 'Parent', opts_button_YAxis,...
            'Style','popup',...
            'String', {'Linear','Log'},...
            'Value',2,...
            'Tag','YAxisPopup');        
...
opts_button_box6 = uix.VButtonBox( 'Parent', box_data_opts,...
                                   ...
                                   'HorizontalAlignment','left',...
                                   'ButtonSize', [100 20] ); 
uicontrol( 'Parent', opts_button_box6,...
            'Style', 'pushbutton',...
            'String', 'Mask data',...
